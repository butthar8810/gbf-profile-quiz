...
{answer:'アーミラ', hints: {element:'光', type:'特殊タイプ', race:'その他', sex:'女', weapon1:'格闘', weapon2:'-', unlock:'ドラゴンスレイヤー', charge:'インヒューマン・ランペイジ', ability:'バルサゴス', support:'片翼の悪魔', age:'年齢：不詳', title:'[舞い降りし少女]'}, image: 'images/chara/アーミラ.png'},
...
{answer:'アダム', hints: {element:'土', type:'防御タイプ', race:'その他', sex:'男', weapon1:'剣', weapon2:'-', unlock:'ゾア・イエシェンナ', charge:'オナー・オブ・エルステ', ability:'インドマタビリティ', support:'宰相の務め', age:'稼働年数の正確な記録無し', title:'[エルステ王国宰相]'}, image: 'images/chara/アダム.png'},
...
{answer:'イーウィヤ', hints: {element:'風', type:'特殊タイプ', race:'その他', sex:'性別：不詳', weapon1:'格闘', weapon2:'-', unlock:'エッタマク・イオ', charge:'イージー・コラプス', ability:'ェダネダン ェティス', support:'ぼーじゃくぶじん', age:'5歳くらいの猫', title:'[『翠』の化猫]'}, image: 'images/chara/イーウィヤ.png'},
...
{answer:'ヴァイト', hints: {element:'闇', type:'攻撃タイプ', race:'その他', sex:'男', weapon1:'短剣', weapon2:'-', unlock:'ブラッディスカー', charge:'プラウド・ブレイド', ability:'フィアー・オブ・ワンスセルフ', support:'ブラッドセイバー', age:'年齢：不明', title:'[血貴]'}, image: 'images/chara/ヴァイト.png'},
...
{answer:'ヴァンピィ', hints: {element:'闇', type:'特殊タイプ', race:'その他', sex:'女', weapon1:'杖', weapon2:'短剣', unlock:'アゾット', charge:'ブラッディ・アブソープション', ability:'テスタメント', support:'セルフィッシュ・ロイヤル', age:'年齢：不明', title:'[吸血姫]'}, image: 'images/chara/ヴァンピィ.png'},
...
{answer:'ウーフとレニー', hints: {element:'闇', type:'攻撃タイプ', race:'その他', sex:'男/女', weapon1:'格闘', weapon2:'銃', unlock:'マスターキー', charge:'ホロウ・ブラスト', ability:'ハルトアイゼン', support:'ケンプファー', age:'不明/9歳', title:'[人狼と少女]'}, image: 'images/chara/ウーフとレニー.png'},
...
{answer:'エリン', hints: {element:'水', type:'回復タイプ', race:'その他', sex:'女', weapon1:'杖', weapon2:'-', unlock:'氷晶刃', charge:'クリスタル・グラシア', ability:'クリスタルクローク', support:'永久の輝き', age:'15歳', title:'[氷晶の先駆者]'}, image: 'images/chara/エリン.png'},
...
{answer:'オーキス', hints: {element:'闇', type:'特殊タイプ', race:'その他', sex:'女', weapon1:'短剣', weapon2:'格闘', unlock:'パラゾニウム', charge:'リゾブル・ブリンガー', ability:'オーダーマリオネット', support:'オートマタ・ロイド', age:'年齢：???', title:'[人形少女]'}, image: 'images/chara/オーキス.png'},
...
{answer:'オロロジャイア', hints: {element:'闇', type:'特殊タイプ', race:'その他', sex:'性別：不詳', weapon1:'斧', weapon2:'杖', unlock:'因果の楔針', charge:'アキエスファルクス', ability:'ミスティカ・オーラム', support:'時と因果の楔', age:'外見年齢は20代半ば/前半', title:'[時竜]'}, image: 'images/chara/オロロジャイア.png'},
...
{answer:'ガレヲン', hints: {element:'土', type:'バランスタイプ', race:'その他', sex:'性別：不詳', weapon1:'杖', weapon2:'-', unlock:'巌迫の躯杖', charge:'大地の鼓動', ability:'祝福の接吻', support:'理外の『金』', age:'20代半ば(ヒト型時)', title:'[六竜の『金』]'}, image: 'images/chara/ガレヲン.png'},
...
{answer:'グレア', hints: {element:'火', type:'攻撃タイプ', race:'その他', sex:'女', weapon1:'格闘', weapon2:'-', unlock:'ドラグクロー', charge:'マッドネスクリーヴ', ability:'マナ・ドラグアグニ', support:'炎術式', age:'17歳', title:'[醒竜姫]'}, image: 'images/chara/グレア.png'},
...
{answer:'コク', hints: {element:'闇', type:'特殊タイプ', race:'その他', sex:'性別：不詳', weapon1:'格闘', weapon2:'-', unlock:'無料で入手', charge:'死瑞祥・獲麟', ability:'吉兆之呪', support:'死滅を司る者', age:'年齢：不詳', title:'[死滅の歪獣]'}, image: 'images/chara/コク.png'},
...
{answer:'サンドリヨン', hints: {element:'闇', type:'攻撃タイプ', race:'その他', sex:'女', weapon1:'短剣', weapon2:'格闘', unlock:'ウルレ・ラム', charge:'ジョリ・フィーユ・アタック', ability:'ヴィザージュ・ジャンベ', support:'全空一のマスコット', age:'生まれたて', title:'[新生マスコット]'}, image: 'images/chara/サンドリヨン.png'},
...
{answer:'ジョイ', hints: {element:'風', type:'特殊タイプ', race:'その他', sex:'性別：不詳', weapon1:'格闘', weapon2:'弓', unlock:'無料で入手', charge:'幸新射矢', ability:'ハマ・ストライク', support:'年越しボディＭｋ-II', age:'1歳', title:'[純真なる釣鐘]'}, image: 'images/chara/ジョイ.png'},
...
{answer:'スイ', hints: {element:'光', type:'回復タイプ', race:'その他', sex:'女', weapon1:'格闘', weapon2:'楽器', unlock:'揺光', charge:'経典漆翠経', ability:'響弦千重波紋', support:'愛する父の形見', age:'年齢：不明', title:'[琵琶語りの愛娘]'}, image: 'images/chara/スイ.png'},
...
{answer:'スクルド', hints: {element:'風', type:'攻撃タイプ', race:'その他', sex:'女', weapon1:'弓', weapon2:'剣', unlock:'戦弓アウスヴァール', charge:'ミリアルデ・ブリッツ', ability:'ツァーロス・ファイレ', support:'誇り高き戦乙女', age:'享年25歳', title:'[ひたむきなる戦乙女]'}, image: 'images/chara/スクルド.png'},
...
{answer:'ネクタル', hints: {element:'風', type:'攻撃タイプ', race:'その他', sex:'男', weapon1:'刀', weapon2:'弓', unlock:'雷上動', charge:'祓掛矢(はらいかけや)天箭', ability:'鬼断ち', support:'シンシャの祈り', age:'年齢：???', title:'[廻天連理]'}, image: 'images/chara/ネクタル.png'},
...
{answer:'ハウヘト', hints: {element:'火', type:'特殊タイプ', race:'その他', sex:'女', weapon1:'杖', weapon2:'-', unlock:'セィワール・ラハブ', charge:'ジャヒーム・アンカー', ability:'ラハブアン・ニハーヤ', support:'零れ落ちし太陽', age:'約30億歳', title:'[不死鳥のもうひとつの欠片]'}, image: 'images/chara/ハウヘト.png'},
...
{answer:'ピィジウ', hints: {element:'光', type:'回復タイプ', race:'その他', sex:'性別：不詳', weapon1:'刀', weapon2:'槍', unlock:'無料で入手', charge:'禁忌緘酒', ability:'神雷・空裂衝', support:'生誕を司る者', age:'年齢：不明', title:'[生誕の忌獣]'}, image: 'images/chara/ピィジウ.png'},
...
{answer:'フィルレイン', hints: {element:'水', type:'特殊タイプ', race:'その他', sex:'女', weapon1:'槍', weapon2:'-', unlock:'銀氷の槍グレイシャー', charge:'シュティレヴァイス', ability:'銀氷の吐息', support:'それが貴方の最後の吐息', age:'年齢：不明', title:'[銀氷の竜乙女]'}, image: 'images/chara/フィルレイン.png'},
...
{answer:'フェニー', hints: {element:'火', type:'回復タイプ', race:'その他', sex:'女', weapon1:'杖', weapon2:'-', unlock:'不死鳥の灯火', charge:'シャラーラ・ハラーラ', ability:'マスダル・ショーラ', support:'不死鳥の神秘', age:'900歳以上', title:'[不死鳥の欠片]'}, image: 'images/chara/フェニー.png'},
...
{answer:'ヘカテー', hints: {element:'火', type:'攻撃タイプ', race:'その他', sex:'女', weapon1:'杖', weapon2:'-', unlock:'夢幻の蝋杖', charge:'夢幻終宵', ability:'火光照らせし月夜', support:'真月の饗宴', age:'年齢：不明', title:'[妖艶なる冥妃]'}, image: 'images/chara/ヘカテー.png'},
...
{answer:'ヘレル・ベン・シャレム', hints: {element:'闇', type:'特殊タイプ', race:'その他', sex:'不詳', weapon1:'槍', weapon2:'杖', unlock:'バブ・エル・マンデブ', charge:'ケイオス・レギオン', ability:'アバカブ', support:'審問と排斥の預言者', age:'年齢：不詳', title:'[宵の審問者]'}, image: 'images/chara/ヘレル・ベン・シャレム.png'},
...
{answer:'ミニゴブ', hints: {element:'光', type:'特殊タイプ', race:'その他', sex:'女', weapon1:'杖', weapon2:'-', unlock:'ケーン・オブ・シャイニー', charge:'ピカピカ・ペイント', ability:'すごいぼんやりするゴブ', support:'人と獣人の架け橋', age:'???歳(数えてないゴブ！)', title:'[覚醒の獣人]'}, image: 'images/chara/ミニゴブ.png'},
...
{answer:'メレアガンス', hints: {element:'土', type:'防御タイプ', race:'その他', sex:'男', weapon1:'格闘', weapon2:'-', unlock:'アルト・ナーゲル', charge:'アルト・ゲブリュル', ability:'シルトシュトルム', support:'アヴァロンの憶竜', age:'27歳(封印された当時の年齢)', title:'[希死の殉難者]'}, image: 'images/chara/メレアガンス.png'},
...
{answer:'ヤチマ', hints: {element:'水', type:'特殊タイプ', race:'その他', sex:'女', weapon1:'杖', weapon2:'-', unlock:'ルベウス・スティーリア', charge:'月ノ祈リ', ability:'ディグレイド・スピネル', support:'幾百年の時を共に', age:'年齢：不明', title:'[裁考密度の純心]'}, image: 'images/chara/ヤチマ.png'},
...
{answer:'リリィ', hints: {element:'水', type:'回復タイプ', race:'その他', sex:'女', weapon1:'杖', weapon2:'-', unlock:'氷晶杖', charge:'フローズン・ブルーム', ability:'氷晶結界', support:'シャインクリスタル', age:'12歳', title:'[氷国の希望]'}, image: 'images/chara/リリィ.png'},
...
{answer:'ルシオ', hints: {element:'光', type:'バランスタイプ', race:'その他', sex:'男', weapon1:'刀', weapon2:'剣', unlock:'エデン', charge:'コール・オブ・エデン', ability:'イヴ・オブ・シダクション', support:'明けの明星', age:'年齢：不詳', title:'[暁の裁定者]'}, image: 'images/chara/ルシオ.png'},
...
{answer:'ロボミ', hints: {element:'光', type:'攻撃タイプ', race:'その他', sex:'女', weapon1:'銃', weapon2:'-', unlock:'レールガン', charge:'ハイパー・ソニック・スマッシャー', ability:'超斥力ストーム', support:'リレーション・コンバーター', age:'年齢：データ不明', title:'[愛宿せし鋼の戦士]'}, image: 'images/chara/ロボミ.png'},
